...
// MARK: Bakalan error kalo lewat segue, dan kalo bukan yang pertama muncul :\
import UIKit
...
extension CustomDetailView {
    ...
    private func createButton() {
        ...
        for buttonTitle in buttonTitles {
            ...
            button.addTarget(self, action:#selector(CustomDetailView.buttonAction(sender:)), for: .touchUpInside)
